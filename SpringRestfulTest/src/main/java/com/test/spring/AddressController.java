...
public class AddressController {
	...
	//2. PUT
	//3. return int
	@PutMapping("/address/{member_seq}")
	public int edit(@PathVariable("member_seq") String member_seq, @RequestBody AddressDTO dto) {
	...
	//2. DELETE
	//3. return int
	@DeleteMapping("/address/{member_seq}")
	public int del(@PathVariable("member_seq") String member_seq) {
		
		return dao.del(member_seq);
	}
