...
<nav id="sidebar" class="sidebar js-sidebar">
	<div class="sidebar-content js-simplebar">
		...
		<ul class="sidebar-nav">
			...
			<li class="sidebar-item" style="font-size:11px;"><a class="sidebar-link"
				href="/spring/memberlist">  &nbsp;&nbsp;<i class="align-middle"
					data-feather="corner-down-right"></i> <span class="align-middle">회원목록</span>
			</a></li>
			<li class="sidebar-item" style="font-size:11px;"><a class="sidebar-link"
				href="/spring/memberlist"> &nbsp;&nbsp;<i class="align-middle"
					data-feather="corner-down-right"></i> <span class="align-middle">회원통계</span>
			</a></li>
